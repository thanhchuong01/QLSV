    ...
    public partial class MoLopTinChiForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void barButtonSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (state == "edit")
                {
                    undoStack.Push(string.Format("UPDATE LOPTINCHI SET NIENKHOA = N'{0}', HOCKY = {1}, MAMH = N'{2}', NHOM = {3}, MAGV = N'{4}', MAKHOA = N'{5}', SOSVTOITHIEU = {6}, HUYLOP = {7} WHERE MALTC = '{8}'", LopTinChiData.NienKhoa, LopTinChiData.HocKy, LopTinChiData.MaMonHoc, LopTinChiData.Nhom, LopTinChiData.MaGiangVien, LopTinChiData.MaKhoa, LopTinChiData.SoSVTT, Convert.ToInt32(LopTinChiData.HuyLop), LopTinChiData.MaLTC));
                }
            }
            catch (Exception ex)
            {
        ...
        private void barButtonDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (XtraMessageBox.Show("Bạn có thực sự muốn xóa lớp tín chỉ này?", "Xác nhận.", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                try
                {
                    ...
                    undoStack.Push(string.Format("INSERT LOPTINCHI (NIENKHOA, HOCKY, MAMH, NHOM, MAGV, MAKHOA, SOSVTOITHIEU, HUYLOP) VALUES (N'{0}', {1}, N'{2}', {3}, N'{4}', N'{5}', {6}, {7})", LopTinChiData.NienKhoa, LopTinChiData.HocKy, LopTinChiData.MaMonHoc, LopTinChiData.Nhom, LopTinChiData.MaGiangVien, LopTinChiData.MaKhoa, LopTinChiData.SoSVTT, Convert.ToInt32(LopTinChiData.HuyLop)));
                }
                catch (Exception ex)
                {

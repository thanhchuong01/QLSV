...
namespace QLSV_HTC.Forms
{
    public partial class DangKyLTCForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void LoadDataSV()
        {
            ...
            string sqlQuery = string.Format("SELECT HO + ' ' + TEN AS HOTEN, MALOP FROM LINK0.QLSV_HTC.DBO.SINHVIEN WHERE MASV = N'{0}'", txtMaSV.Text.Trim());
        ...
        private void LoadData()
        {
            ...
            while (Program.MyReader.Read())
            {
                ...
                string hoTen = (string)Program.MyReader["TEN"];
                int soluongtoithieu = (int)Program.MyReader["SOSVTT"];

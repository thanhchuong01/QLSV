...
namespace QLSV_HTC.Forms
{
    public partial class DiemForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void sp_GetBangDiemMonHocBindingSource_CurrentChanged(object sender, EventArgs e)
        {

        }

        private void sp_GetDS_LTCGridControl_Click(object sender, EventArgs e)
        {
        ...
        private void gc_DSSV_DANGKY_Click(object sender, EventArgs e)
        {

    ...
    public partial class SinhVienForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void gridView2_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            try
            {
                ...
                String MaCN = ((DataRowView)bdsSINHVIEN[bdsSINHVIEN.Position])["MaCN"].ToString();
                sv = new SinhVienClass(TextBox_MaSV.Text.Trim(), TextBox_Ho.Text.Trim(), TextBox_Ten.Text.Trim(), phai.ToString(), dIACHITextBox.Text.Trim(), DateEdit_NgaySinh.DateTime.ToString("yyyy/MM/dd"), Nghihoc.ToString(), Malop, MaCN);
            }
            catch { }
